...
module.exports = {
HACKER : process.env.HACKER ||                      "94718087916" , // your number මේ නම්බර් එකට තමා control කරන්න පුලුවන් user ලව
...
CONNECT_MSG_IMG : process.env.CONNECT_MSG_IMG ||      '', // connect msg img කනෙක්ට් මැසේජ් පොටෝ එක true=on,false=off
...
CONNECT_MSG_SEND : process.env.CONNECT_MSG_SEND ||   'false', // connect msg send කනෙක්ට් මැසේජ් එක true=on,false=off
USE_MONGODB : process.env.USE_MONGODB ||             'false', // Use MongoDB for sessions true=on,false=off
MONGODB_URI : process.env.MONGODB_URI ||            'mongodb://udmodz:udmodz@atlas-sql-68c0ede2bacbeb746c29a8fc-caihxp.a.query.mongodb.net/sample_mflix?ssl=true&authSource=admin', // MongoDB connection URI
